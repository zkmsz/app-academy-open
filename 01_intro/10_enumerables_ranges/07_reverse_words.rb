...
# sentence with the order of the characters in each word reversed. Note that
# we need to reverse the order of characters in the words, do not reverse the
# order of words in the sentence.
def reverse_words(sent)
  sent.split(" ").each(&:reverse!).join(" ")
end
