...
# an arguments. The method should return a boolean indicating whether or not
# at least n elements of the array return true when given to the block. Solve
...
def at_least?(array, n, &block)
  array.each.count { |el| block.call(el) } >= n
end
